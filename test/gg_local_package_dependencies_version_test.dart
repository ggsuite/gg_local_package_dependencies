...
// lib/src/gg_local_package_dependencies_version.dart
// when it drifts from pubspec.yaml. Drift is not an error here: the literal
// is rewritten and the test passes.

void main() {
  group('gg_local_package_dependencies_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      const declaration = 'const String ggLocalPackageDependenciesVersion = ';
      final match = RegExp(
        r'^version:\s*(\S+)\s*$',
        multiLine: true,
      ...
      final file = File('lib/src/gg_local_package_dependencies_version.dart');
